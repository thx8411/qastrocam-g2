...
par F. Sicard et modif\'ee par moi-m\^eme pour mes propres besoins. Qastrocam-g2 \'etant
...
g\'en\'eriques ainsi que les sp\'ecificit\'e de certains pilotes (notamment pour les webcams
CCD philipps). Le passage aux pilotes V4L2 est pr\'evu pour la version 4.5.
...
Qastrocam-g2 supporte les palettes V4L suivantes. Ces palettes sont test\'es par ordre de qualit\'e,
...
V4L. Ils sont accessibles dans l'interface graphique par l'interm\'diaire de curseurs.

\subsubsection{Nombre d'images par secondes}

\paragraph*{}
Le nombre d'images par seconde (framerate) utili\'es est celui-ci du standard vid\'eo d\'etect\'e,
